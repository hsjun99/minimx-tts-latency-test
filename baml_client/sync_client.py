...
class BamlSyncClient:
    ...
    def GenerateMultiRAGQuery_Baseten_GPT_OSS_120B_Low(self, conversation_history: typing.List["types.ConversationMessage"],user_query: str,
        ...
        if 'on_tick' in baml_options:
            ...
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="GenerateMultiRAGQuery_Baseten_GPT_OSS_120B_Low", args={
    ...
    def GenerateMultiRAGQuery_Baseten_GPT_OSS_120B_Medium(self, conversation_history: typing.List["types.ConversationMessage"],user_query: str,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="GenerateMultiRAGQuery_Baseten_GPT_OSS_120B_Medium", args={
                "conversation_history": conversation_history,"user_query": user_query,
            })
            return typing.cast(types.MultiRAGQueryResult, result.cast_to(types, types, stream_types, False, __runtime__))
...
class BamlStreamClient:
    ...
    def GenerateMultiRAGQuery_Baseten_GPT_OSS_120B_Low(self, conversation_history: typing.List["types.ConversationMessage"],user_query: str,
        ...
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="GenerateMultiRAGQuery_Baseten_GPT_OSS_120B_Low", args={
            "conversation_history": conversation_history,"user_query": user_query,
        })
    ...
    def GenerateMultiRAGQuery_Baseten_GPT_OSS_120B_Medium(self, conversation_history: typing.List["types.ConversationMessage"],user_query: str,
        ...
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="GenerateMultiRAGQuery_Baseten_GPT_OSS_120B_Medium", args={
            "conversation_history": conversation_history,"user_query": user_query,
        })
        return baml_py.BamlSyncStream[stream_types.MultiRAGQueryResult, types.MultiRAGQueryResult](
          result,
...
class BamlHttpRequestClient:
    ...
    def GenerateMultiRAGQuery_Baseten_GPT_OSS_120B_Low(self, conversation_history: typing.List["types.ConversationMessage"],user_query: str,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="GenerateMultiRAGQuery_Baseten_GPT_OSS_120B_Low", args={
            "conversation_history": conversation_history,"user_query": user_query,
        }, mode="request")
        return result
    def GenerateMultiRAGQuery_Baseten_GPT_OSS_120B_Medium(self, conversation_history: typing.List["types.ConversationMessage"],user_query: str,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="GenerateMultiRAGQuery_Baseten_GPT_OSS_120B_Medium", args={
            "conversation_history": conversation_history,"user_query": user_query,
        }, mode="request")
        return result
    def GenerateMultiRAGQuery_Cerebras_GPT_OSS_120B_Low(self, conversation_history: typing.List["types.ConversationMessage"],user_query: str,
